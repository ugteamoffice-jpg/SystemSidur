...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; font-family: "VR", sans-serif !important; }
    ...
    .company-name { margin:0 0 4px 0; font-size:24px; color:#0f172a; font-weight:800; font-family:"VR", sans-serif; }
    .cd { font-size:13px; color:#64748b; margin-bottom:8px; font-family:"VR", sans-serif; }
    .report-title { margin:8px 0 4px 0; font-size:20px; color:#0f172a; font-weight:700; font-family:"VR", sans-serif; }
    .me { font-size:15px; color:#1e40af; font-weight:700; margin-bottom:4px; }
    .mi { font-size:13px; color:#475569; margin-bottom:3px; font-family:"VR", sans-serif; }
    .mf { font-size:12px; color:#64748b; max-width:400px; line-height:1.3; margin:4px auto 0; }
    table { width:100%; border-collapse:collapse; margin-bottom:20px; font-family:"VR", sans-serif; }
    th { background:#f8fafc; color:#334155; font-weight:700; padding:11px 7px; text-align:right; border-bottom:2px solid #cbd5e1; white-space:nowrap; font-size:13px; font-family:"VR", sans-serif; }
    td { padding:9px 7px; border-bottom:1px solid #f1f5f9; vertical-align:middle; font-size:13px; font-family:"VR", sans-serif; }
    ...
    .ftr { margin-top:30px; text-align:center; font-size:12px; color:#94a3b8; border-top:1px solid #e2e8f0; padding-top:15px; font-family:"VR", sans-serif; }
    .fc { margin-top:5px; color:#64748b; font-family:"VR", sans-serif; }
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; font-family: "VR", sans-serif !important; }
    body { font-family: "VR", sans-serif; direction: rtl; padding: 5px 10px; font-size: 11px; color: #1e293b; line-height: 1.4; background: #fff; }
    ...
    .company-name { margin:0 0 2px 0; font-size:20px; color:#0f172a; font-weight:800; font-family:"VR", sans-serif; }
    .cd { font-size:11px; color:#64748b; margin-bottom:5px; font-family:"VR", sans-serif; }
    .report-title { margin:5px 0 3px 0; font-size:15px; color:#0f172a; font-weight:700; font-family:"VR", sans-serif; }
    .mi { font-size:11px; color:#475569; margin-bottom:2px; font-family:"VR", sans-serif; }
    table { width:100%; border-collapse:collapse; margin-bottom:10px; font-family:"VR", sans-serif; }
    th, td { border: 1px solid #cbd5e1; padding: 4px 3px; text-align: center; vertical-align: middle; font-family:"VR", sans-serif; }
    ...
    .ftr { margin-top:15px; text-align:center; font-size:11px; color:#94a3b8; border-top:1px solid #e2e8f0; padding-top:8px; font-family:"VR", sans-serif; }
    .fc { margin-top:3px; color:#64748b; font-family:"VR", sans-serif; }
    @media print { body { padding:0; } }
  </style>
</head>
<body>
